DROP DATABASE IF EXISTS sw15_update;
CREATE DATABASE sw15_update CHARACTER SET utf8mb4;
USE sw15_update;
...
CREATE TABLE tb_classes(
    ...
    class_part ENUM("Firts","Second") not null default "Firts",
...
CREATE TABLE tb_classworks(
    ...
    part_classwork ENUM("Firts","Second", "Graded") not null default "Firts",
