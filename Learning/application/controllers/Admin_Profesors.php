			...
			if ($this->form_validation->run()) {
				if ($extValidation) {
					...
					if (!$exist) {
						...
						//$email = $this->input->post('inpName')."-".$this->input->post('inpLastname').$user_id."@learning.edu";
					...
					} else if ($this->input->post("option") == "inactivate") {
						$data     = array(
					...
					} else if ($this->input->post("option") == "reactive") {
						$data     = array(
							"status_user" => "Active",
						);
						$filter   = array(
