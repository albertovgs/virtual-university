<div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-lg-6 col-4">
        <div class="small-box bg-info">
          ...
          <a href="javascript::" class="small-box-footer" data-toggle="modal" data-target="#coordinator_modal"
            id="regCoordinator">
  ...
  <section class="content">
    ...
    <div class="modals">
      <div class="modal fade" id="coordinator_modal">
        <div class="modal-dialog" id="crdContent">
