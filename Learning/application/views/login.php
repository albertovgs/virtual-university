...
<html lang="en">
  ...
  <head>
    ...
    <link href="<?= base_url("resources/plugins/fontawesome-free/css/all.min.css"); ?>" rel="stylesheet"
      type="text/css">
    <link
                ...
                <div class="col-lg-6">
                  <div class="p-5">
                    <div class="text-center">
                      <img src="<?= base_url("resources/dist/img/isotype.png"); ?>" class="mx-auto d-block"
                        alt="isotype">
