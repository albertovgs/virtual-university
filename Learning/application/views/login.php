...
<head>
  ...
  <link rel="icon" href="<?= base_url("resources/dist/img/isotype.png"); ?>" sizes="190x190">
...
<body class="bg-gradient-primary">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <img src="<?= base_url("resources/dist/img/isotype.png"); ?>" class="mx-auto d-block" alt="isotype">
                  ...
                  <form class="user" action="<?= base_url('login/auth'); ?>" method="post">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="exampleInputEmail"
                        aria-describedby="emailHelp" placeholder="Enter Email Address..." name="inpEmail" id="inpEmail">
                    </div>
                    <div class="form-group">
  ...
  <script src="<?= base_url("resources/plugins/sb-admin-2.min.js"); ?>"></script>
</body>
